...
class LocalDeterministicStubClient:
    ...
    def _generate_article(self, *, system_prompt: str, user_prompt: str) -> str:
        ...
        return (
            ...
            f"## FAQ\n"
            f"### Q1. なぜ最初にSummaryが必要ですか？\n"
            f"A1. AIは冒頭情報を優先的に要約するため、結論先行が引用率を高めるからです。\n\n"
            f"### Q2. 定義文はどの程度厳密に書くべきですか？\n"
            f"A2. 「{keyword}とは、〜である」の形式で1文で断定すると安定します。\n\n"
            f"### Q3. 表は必須ですか？\n"
            f"A3. 比較軸を明示できるため、可読性とAIの参照効率が向上します。\n"
        )
